...
const reviewData = [
  ...
  category("技术基础", [
    ...
    section("database-sql", "数据库与 SQL", "content/tech-base/database-sql/index.md", [
      article("sql-basics", "01_SQL基础语法", "content/test-base/database-sql/sql-basics.md"),
      article("joins-and-subqueries", "02_SQL连接与子查询", "content/test-base/database-sql/joins-and-subqueries.md"),
      article("window-functions-and-faq", "03_SQL窗口函数与高频题", "content/test-base/database-sql/window-functions-and-faq.md"),
      article("sql-scenario-problems", "04_测试场景SQL", "content/test-base/database-sql/sql-scenario-problems.md"),
      article("database-fundamentals", "05_数据库基础概念", "content/test-base/database-sql/database-fundamentals.md"),
      article("transactions-and-concurrency-control", "06_事务与并发控制", "content/test-base/database-sql/transactions-and-concurrency-control.md"),
      article("indexes-and-execution-plans", "07_索引与执行计划", "content/test-base/database-sql/indexes-and-execution-plans.md"),
      article("slow-queries-and-troubleshooting", "08_慢查询与排查基础", "content/test-base/database-sql/slow-queries-and-troubleshooting.md"),
      article("database-and-sql-interview-faq", "09_数据库与SQL笔面试高频题", "content/test-base/database-sql/database-and-sql-interview-faq.md"),
    ]),
